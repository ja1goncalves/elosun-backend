...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'station'               => "Estatações",
        'provider.cpf_cnpj'     => 'CPF ou CNPJ do fornecedor',
        'client.cpf_cnpj'       => 'CPF ou CNPJ do cliente',
        ...
        "provider.email"                    => "E-mail do fonecedor",
        "provider.password"                 => "Senha do fornecedor",
        "provider.phone"                    => "Telefone do fornecedor",
        "provider.cellphone"                => "Celular do fornecedor",
        "provider.user_id"                  => "Usuário do fornecedor",
        "provider.address"                  => "Endereço do fornecedor",
        "provider.address.id"               => "ID do endereço do fornecedor",
        "provider.address.state"            => "Estado do endereço",
        "provider.address.zip_code"         => "CEP do endereço",
        "provider.address.city"             => "Cidade",
        "provider.address.street"           => "Rua",
        "provider.address.number"           => "Número",
        "provider.station"                  => "Estação do fornecedor",
        "provider.station.code_gd"          => "Código GD",
        "provider.station.address"          => "Endereço da estação",
        "provider.station.address.state"    => "Estado da estação",
        "provider.station.address.zip_code" => "CEP da estação",
        "provider.station.address.city"     => "Cidade da estação",
        "provider.station.address.street"   => "Rua da estação",
        "provider.station.address.number"   => "Número da estação",
        "provider.bank"                     => "Banco do fornecedor",
        "provider.bank.agency"              => "Agência do fornecedor",
        "provider.bank.account"             => "Conta do fornecedor",
        "provider.bank.account_dv"          => "Dígito verificador da conta",
        "provider.bank.agency_dv"           => "Dígito verificador da agência",
        "provider.bank.type"                => "Tipo de conta",
        "provider.bank.bank_id"             => "Banco do fornecedor",
        "provider.bank.segment_id"          => "Segmento da conta",
    ],
